...
const newsletter_1 = __importDefault(require("./userActions/newsletter"));
...
router.post("/subscribe", (0, policy_middlewares_1.default)(user_policies_1.newsletterSchema), newsletter_1.default);
