...
router.post("/", (0, policy_middlewares_1.default)(blog_policies_1.createBlogSchema), validateToken_1.default, requireAuth_1.default, (0, hasPermission_1.default)(["admin"]), fileUpload_config_1.upload.single("blog-image"), imgeUpload_1.uploadImageMiddleware, create_Blog_1.default);
router.get("/", getBlog_1.getBlog);
router.patch("/update", (0, policy_middlewares_1.default)(blog_policies_1.editBlogSchema), validateToken_1.default, requireAuth_1.default, (0, hasPermission_1.default)(["admin"]), fileUpload_config_1.upload.single("blog-image"), imgeUpload_1.uploadImageMiddleware, edit_Blog_1.default);
router.delete("/:blogId/:imageId", validateToken_1.default, requireAuth_1.default, (0, hasPermission_1.default)(["admin"]), delete_Blog_1.deleteBlog);
