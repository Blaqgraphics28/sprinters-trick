...
authSchema.methods.generateToken = ({ data, expiresIn = authConfigs.sessionLifeSpan, audience = "web", }) => jsonwebtoken_1.default.sign(data, authConfigs.jwtSecret, {
    expiresIn,
    issuer: `sprinters-${configs_1.default.environment}`,
