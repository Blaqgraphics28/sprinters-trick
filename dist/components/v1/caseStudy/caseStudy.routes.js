...
router.post("/", (0, policy_middlewares_1.default)(caseStudy_policies_1.createCaseStudySchema), createCaseStudy_1.default);
router.get("/", getCaseStudy_1.default);
router.delete("/:caseStudyId", deleteCaseStudy_1.default);
router.post("/upload/image", fileUplod_config_1.upload.single("cover-photo"), uploadImage_1.uploadImage);
